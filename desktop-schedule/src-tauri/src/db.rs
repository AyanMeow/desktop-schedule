...
fn seed_encouragements(conn: &Connection) -> anyhow::Result<()> {
    ...
    let items: &[(&str, &str)] = &[
        ...
        ("这项任务被老大轻松拿下喵，向最强的猎人致敬！", "热血"),
        ("一鼓作气喵！老大离传说级猎人又近了一步！", "热血"),
        ("老大的执行力，连看板娘都竖起大拇指喵！", "热血"),
        ("又是满载而归的一天喵，老大就是咱们的骄傲！", "热血"),
        ("这股拼劲保持下去，整个公会都没有老大的对手喵！", "热血"),
        // 调皮（原幽默）
        ("喵！这任务看到老大，吓得自己变成素材跑掉了喵！", "调皮"),
        ("叮！老大经验值 +1，快升级了喵要不要回去交任务？", "调皮"),
        ("任务完成喵！老大要不要奖励自己一份猫饭？", "调皮"),
        ("今日老大战斗力评测：HR 解锁级喵！", "调皮"),
        ("这效率喵，连工坊的大叔都想拉老大去打铁了！", "调皮"),
        ("悄悄说一句，老大刚才那波操作帅到本喵了喵！", "调皮"),
        // 暖心（原温柔）
        ("慢慢来就好喵，老大今天已经很努力了喵。", "暖心"),
        ("记得喝口水休息一下喵，老大辛苦啦。", "暖心"),
        ("别太勉强自己喵，累了就回营地歇会儿吧。", "暖心"),
        ("哪怕只完成一项，老大在咱们心里也是最棒的喵。", "暖心"),
        ("深呼吸喵，不管多难的任务，咱们一起扛喵。", "暖心"),
