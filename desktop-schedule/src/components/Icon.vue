...
// 轻量 SVG 图标库（Lucide 风格线条图标，stroke 继承 currentColor）
...
<template>
  ...
  >
    ...
    <template v-else-if="name === 'pin'">
      <path d="M12 17v5" />
      <path d="M9 10.76V6h6v4.76l2 3.24H7l2-3.24z" />
    </template>
    <!-- 设置（齿轮简化） -->
    ...
    <template v-else-if="name === 'cloud'">
      <path d="M17.5 19a4.5 4.5 0 1 0-1.4-8.78A6 6 0 0 0 4 12.5 4.5 4.5 0 0 0 6.5 21h11z" />
    </template>
    <!-- 雨（云+雨滴） -->
    <template v-else-if="name === 'rain'">
      <path d="M17.5 16a4.5 4.5 0 1 0-1.4-8.78A6 6 0 0 0 4 9.5 4.5 4.5 0 0 0 6.5 18h11z" />
